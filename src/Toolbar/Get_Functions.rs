...
use crate::toolbar_render::Button;
...
pub fn get_toolbar_Functions() -> Vec<Button>
{

  let mut buttons_Found: Vec<Button> = Vec::new();
  let dir = "C:\\Users\\aidan\\Desktop\\VsRust\\3Cad\\Three_Cad\\3Cad_Scripts"; // replace with your desired directory
